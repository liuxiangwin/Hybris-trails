 ...
 *  
 */
package de.hybris.alantrails.core.hmc;
...
/**
 * Provides necessary meta information about the alantrailscore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class AlantrailsCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AlantrailsCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.hybris.alantrails.core.hmc.locales";
