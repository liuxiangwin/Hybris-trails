 ...
 *  
 */
package de.hybris.alantrails.test.setup;
...
import de.hybris.alantrails.test.constants.AlantrailsTestConstants;
import de.hybris.alantrails.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AlantrailsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/alantrailstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/alantrailstest/import/reviews.impex");
			...
			importImpexFile(context, "/alantrailstest/import/cstickets.impex");
		}
	}
}
