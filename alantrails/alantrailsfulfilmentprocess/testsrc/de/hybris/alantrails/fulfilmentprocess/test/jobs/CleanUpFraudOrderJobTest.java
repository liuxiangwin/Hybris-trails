 ...
 *  
 */
package de.hybris.alantrails.fulfilmentprocess.test.jobs;
...
import de.hybris.alantrails.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = AlantrailsFulfilmentProcessConstants.ORDER_PROCESS_NAME;
