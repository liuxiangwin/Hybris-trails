 ...
 *  
 */
package de.hybris.alantrails.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, AlantrailsFulfilmentProcessConstants.PARENT_PROCESS);
