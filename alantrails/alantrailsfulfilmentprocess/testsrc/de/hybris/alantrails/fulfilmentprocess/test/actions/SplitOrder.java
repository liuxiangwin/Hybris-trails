 ...
 *  
 */
package de.hybris.alantrails.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AlantrailsFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AlantrailsFulfilmentProcessConstants.PARENT_PROCESS);
